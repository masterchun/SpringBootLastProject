			...
			<div class="row">
				<table class="table">
					<tbody>
						...
						<tr>
							<td colspan="4" class="text-right"><a href="/notice/list"
								class="btn btn-sm btn-warning">목록</a></td>
						</tr>
						<c:if test="${vo.filecount > 0 }">
							<c:forTokens items="${vo.filename }" delims="," var="img">
								<tr>
									<td class="text-center" colspan="4"><img
										src="/upload/${img }" style="width: 600px; height: 350px;">
									</td>
								</tr>
							</c:forTokens>
						</c:if>
