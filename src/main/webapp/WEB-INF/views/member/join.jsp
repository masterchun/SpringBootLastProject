              ...
              <form id="frm" ref="frm" method="post" action="/member/join_ok">
               <table class="table table-bordered table-hover">
                 <tr>
                   ...
                   <td>
                     <div class="form-inline">
                       ...
                       &nbsp;<span style="color: red;font-size: 12px;">{{idOk}}</span>
                     </div>
                   </td>
                 </tr>
                 ...
                 <tr>
                   ...
                   <td><input type="date" name="birthday" ref="birthday" v-model="birthday" class="form-control input-sm"></td>
                 </tr>
         
                 <tr>
                   <th class="text-center">이메일</th>
                   <td><input type="text" name="email" ref="email" v-model="email" class="form-control input-sm" placeholder="example@email.com"></td>
                 </tr>
                 ...
                 <tr>
                   ...
                   <td>
                     <div class="form-inline">
                       <input type="text" ref="post" name="post" v-model="post" class="form-control input-sm" readonly>
                 ...
                 <tr>
                   ...
                   <td><input type="text" ref="addr1" name="addr1" v-model="addr1" class="form-control input-sm" readonly></td>
                 </tr>
         
                 <tr>
                   <th class="text-center">상세주소</th>
                   <td><input type="text" name="addr2" v-model="addr2" class="form-control input-sm"></td>
                 </tr>
                 ...
                 <tr>
                   ...
                   <td><textarea rows="5" name="content" v-model="content" class="form-control input-sm" placeholder="자기소개를 입력하세요"></textarea></td>
                 </tr>
